...
const Button = ({
  ...
  const variantClasses = {
    primary: 'bg-[#D4AF37] text-[#1A2A4A] hover:bg-[#C4A027] active:bg-[#B49017]',
    secondary: 'bg-[#1A2A4A] text-white hover:bg-[#2A3A5A] active:bg-[#0A1A3A]',
    outline: 'bg-transparent border border-[#D4AF37] text-[#D4AF37] hover:bg-[#D4AF37]/10 active:bg-[#D4AF37]/20'
  };
  const sizeClasses = {
